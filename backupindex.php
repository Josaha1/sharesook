...
<head>
    ...
    <style>
        ...
        .carousel-item {
            flex: 0 0 25%;
            /* Adjust the width of carousel items as needed */
...
<body>
    <main class="flex-shrink-0">
        ...
        <div class="container">
            ...
            <!-- Course -->
            <section id="Course" class="CourseSection" style="margin-bottom:15rem;">
                <div class="row">
                    <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-12 col-sm-12">
                        ...
                        <div class="row mb-5">
                            <div class="col-xxl-5 col-xl-5 col-md-5 col-sm-12 mb-2 align-items-center align-content-center text-center">
                            ...
                            <div class="col-xxl-7 col-xl-7 col-md-7 col-sm-12 mb-2 text-left ">
    ...
    <script>
        ...
        //Course
        var multipleCardCourse = document.querySelector(
            "#courseExampleControls"
        );
        if (window.matchMedia("(min-width: 768px)").matches) {
            var course = new bootstrap.Carousel(multipleCardCourse, {
                interval: false,
            });
            var courseWidth = $(".course-inner")[0].scrollWidth;
            var cardWidth = $(".course-item").width();
            var scrollPosition = 0;
            $("#courseExampleControls .course-control-next").on("click", function() {
                if (scrollPosition < courseWidth - cardWidth * 4) {
                    scrollPosition += cardWidth;
                    $("#courseExampleControls .course-inner").animate({
            ...
            $("#courseExampleControls .course-control-prev").on("click", function() {
                if (scrollPosition > 0) {
                    scrollPosition -= cardWidth;
                    $("#courseExampleControls .course-inner").animate({
                            scrollLeft: scrollPosition
            ...
            $(multipleCardCourse).addClass("slide");
        }
